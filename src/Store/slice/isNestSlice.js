...
const isNestSlice = createSlice({
  ...
  reducers: {
    ...
    setNicknameNestMessage(state, action) {
      state.nicknameNestMessage = action.payload.message;
      state.nicknameNestError = action.payload.error;
    },
  },
});
